    ...
    <body>  
        ...
        <div id="Create" class="section scrollspy">
            <div class="row container">
                <h2 class="header">Create ingredient</h2>
                <div class="row">
                ...
                <div class="row">
                    <form class="col s12">
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <input placeholder="e.g. A pinch"id="Quantity" type="text" class="validate">
        ...
        <script src="./js/json_manager.js?v=8" type="text/javascript"></script>      
        <script>
            ...
            $("#create_button").click(function () {
                var ingredientName = $("#Name").val();
                var quantity = $("#Quantity").val();
                var recipeID = $("#dropdown").val();
                if (ingredientName === '' || quantity === '') {
                    sweetAlert("Oops...", "All fields must be filled in!", "info");
                } else {
                    create_ingredient(ingredientName, quantity, recipeID);
                }
            });
        </script>
    </body>        
